...
|--------|------|-------------|---------|
| build-loop | [tyroneross/build-loop](https://github.com/tyroneross/build-loop) | Portable multi-phase build loop for Claude Code, Codex, and AGENTS.md-aware tools | 0.39.0 |
