---
name: feedback
description: Report a bug or send feedback about the agent-builder plugin
---

# Report agent-builder feedback

File the user's report as a GitHub issue on `tyroneross/RossLabs-AI-Toolkit`. Issues are this plugin's
...
```bash
gh issue create --repo tyroneross/RossLabs-AI-Toolkit \
...
5. If `gh` is missing or unauthenticated, do not fail — print the URL so the user
   can open it in a browser: https://github.com/tyroneross/RossLabs-AI-Toolkit/issues/new
