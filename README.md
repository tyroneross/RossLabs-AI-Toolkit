...
|--------|---------|--------------|
| [build-loop](https://github.com/tyroneross/build-loop) | `0.46.0` | The flagship build loop. Plans, reviews, and verifies every multi-file change. See **Featured** above for the full breakdown. |
