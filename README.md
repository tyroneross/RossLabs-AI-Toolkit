...
| [research](https://github.com/tyroneross/research-plugin) | `0.6.0` | Token-efficient research KB — SQLite FTS5, source tier scoring, claim + quantitative verification, bulk ingest, project symlinks. |
