...
| [ibr](https://github.com/tyroneross/interface-built-right) | `1.3.0` | UI validation — verify implementations match intent with live page scanning and visual regression. |
