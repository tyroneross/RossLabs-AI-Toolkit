...
description: Reviews autoresearch experiment results for overfitting, Goodhart violations, and test-gaming shortcuts. Read-only adversarial review. Checks that improvements are genuine and generalizable, not test-harness artifacts.
model: sonnet
